 ...
 *
 * Copyright (c) 2002-2012 Cepstral LLC.  All rights reserved.
 *
...
SWIFT_API
void
LM_request_summary_report(swift_engine *engine, int *max_tokens,
                                   int *tokens_in_use);

SWIFT_API
void LM_request_detailed_report(swift_engine *engine, int *max_tokens, int *tokens_in_use, int *detailed_report_flag);
